...
using blueravencrm.ViewModels;
using blueravencrm.Helpers;
using blueravencrm.Authorization;
...
namespace blueravencrm
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("blueravencrm"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "blueravencrm API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "blueravencrm API V1");
            });
